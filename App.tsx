...
const App: React.FC = () => {
  ...
  const [bookingDisplayMode, setBookingDisplayMode] = useState<BookingDisplayMode>('calendar'); 
          ...
          {activeView === 'cashControl' && (
           ...
           {activeView === 'configuration' && (
              <Configuration 
                ...
                onFactoryReset={async () => setIsResetModalOpen(true)} // FIXED: Passed as async function
              />
          )}
